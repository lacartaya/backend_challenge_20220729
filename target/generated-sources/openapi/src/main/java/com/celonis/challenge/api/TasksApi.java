...
public interface TasksApi {
     ...
     * Creates a new task. For the current legacy flow, the body is minimal; fields not provided will be generated by the server. 
     *
     * @param task  (required)
    ...
    @Operation(
        ...
        summary = "Create task",
        description = "Creates a new task. For the current legacy flow, the body is minimal; fields not provided will be generated by the server. ",
        tags = { "Tasks" },
        responses = {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"storageLocation\" : \"/var/tmp/a1b2c3.zip\", \"id\" : \"a1b2c3\", \"creationDate\" : \"2025-10-17T12:34:56Z\" }";
    ...
    default ResponseEntity<List<Task>> listTasks(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"storageLocation\" : \"/var/tmp/a1b2c3.zip\", \"id\" : \"a1b2c3\", \"creationDate\" : \"2025-10-17T12:34:56Z\" }, { \"storageLocation\" : \"/var/tmp/a1b2c3.zip\", \"id\" : \"a1b2c3\", \"creationDate\" : \"2025-10-17T12:34:56Z\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
